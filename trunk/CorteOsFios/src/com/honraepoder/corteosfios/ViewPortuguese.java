...
public class ViewPortuguese extends View implements Runnable
{
	...
	public ViewPortuguese(Context context)
	{
	...
	public void draw(Canvas canvas) {
		...
		if(maquinaDeEstado == 2)
		{
			...
			canvas.drawText("Total de Mortes: "+(int)totalDeMortes+" | "+"Tempo Gasto: "+(int)tempoGasto+"s",1,getHeight()/2.88f, paint); paint.setColor(Color.BLACK);
		}
		if(maquinaDeEstado == 0)
		{
